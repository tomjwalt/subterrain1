  ...
  return (
    <section className="mt-2">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          type="button"
          className="text-[0.7rem] uppercase tracking-[0.2em] text-zinc-400 hover:text-white border border-zinc-700 hover:border-zinc-400 rounded-full px-3 py-1 transition"
        >
          View all
        </button>
      </div>
